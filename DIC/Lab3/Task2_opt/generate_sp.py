...
def load_parameter_lists():
    ...
    # 格式：参数名: (中心值, 扫描半径, 步长)
    scan_config = {
        'XNAND2_size': (center['XNAND2_size'], 2, 1),      # 2±2, 步长1 -> [1, 2, 3, 4]
        'XNOR2_size': (center['XNOR2_size'], 2, 1),        # 2±2, 步长1 -> [1, 2, 3, 4]
        'buffer_0_size': (center['buffer_0_size'], 3, 1),  # 6±3, 步长1 -> [3, 4, 5, 6, 7, 8, 9]
        'buffer_1_size': (center['buffer_1_size'], 9, 3),  # 27±9, 步长3 -> [18, 21, 24, 27, 30, 33, 36]
    }
