...
```
$M=2$时，两个系统的零极点图、幅度响应和相位响应见：
![alt text](4-39_M=2.png)
$M=3$时，两个系统的零极点图、幅度响应和相位响应见：
![alt text](4-39_M=3.png)
$M=4$时，两个系统的零极点图、幅度响应和相位响应见：
![alt text](4-39_M=4.png)
$M=5$时，两个系统的零极点图、幅度响应和相位响应见：
![alt text](4-39_M=5.png)
