...
& 1. Czochralski法 & \textbf{原理：}Ar保护气氛中，将EGS硅在SiO$_2$坩埚中加热至1417°C以上熔化，单晶籽晶浸入熔体后缓慢提拉旋转生长 \\
& & \textbf{目的：}产生长晶锭(boule) \\
...
\cline{2-3}
& 3. 切片(Slicing) & \textbf{方法：}使用金刚石切割器将晶锭切成薄片，要求切割面平整，损伤层最小 \\
