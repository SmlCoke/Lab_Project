...
Xbuffer_0 word_2 buffer_out_0 vdd gnd INV size = 'buffer_0_size' Lg='20n'
...
def load_parameter_lists():
    ...
    # 格式：参数名: (中心值, 扫描半径, 步长)
    scan_config = {
        'XinvPA0_size': (center['XinvPA0_size'], 1, 1),      # 2±1, 步长1 -> [1, 2, 3]
        'XNAND2_size': (center['XNAND2_size'], 1, 1),      # 2±1, 步长1 -> [1, 2, 3]
        'XNOR3_size': (center['XNOR3_size'], 1, 1),        # 1±1, 步长1 -> [1, 2]
        'buffer_0_size': (center['buffer_0_size'], 1, 1),  # 2±1, 步长1 -> [2, 3, 4]
        'buffer_1_size': (center['buffer_1_size'], 2, 2),  # 8±2, 步长2 -> [6, 8, 10]
        'buffer_2_size': (center['buffer_2_size'], 9, 3),  # 40±9, 步长3 -> [34, 37, 40, 43, 46.49]
    }
