...
Xbuffer_0 word_1 buffer_out_0 vdd gnd INV SN='CM_buffer_0' SP='CM_buffer_0' Lg='20n'
...
def load_parameter_lists():
    ...
    # 格式：参数名: (中心值, 扫描半径, 步长)
    scan_config = {
        'CM_XinvPA0': (center['CM_XinvPA0'], 1, 1),      # 4±1, 步长1 -> [3, 4, 5]
        'CM_NAND2': (center['CM_NAND2'], 1, 1),      # 4±1, 步长1 -> [3, 4, 5]
        'CM_NOR3': (center['CM_NOR3'], 1, 1),        # 1±1, 步长1 -> [1, 2]
        'CM_buffer_0': (center['CM_buffer_0'], 1, 1),  # 3±1, 步长1 -> [2, 3, 4]
        'CM_buffer_1': (center['CM_buffer_1'], 2, 2),  # 13±2, 步长2 -> [11, 13, 15]
        'CM_buffer_2': (center['CM_buffer_2'], 9, 3),  # 57±9, 步长3 -> [48, 51, 54, 57, 60, 63, 66]
    }
